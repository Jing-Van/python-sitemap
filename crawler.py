...
class Crawler:
	...
	# not_parseable_resources = (".epub", ".mobi", ".docx", ".doc",
	# 						   ".opf", ".7z", ".ibooks", ".cbr", ".avi",
	# 						   ".mkv", ".mp4", ".jpg", ".jpeg", ".png",
	# 						   ".gif" ,".pdf", ".iso", ".rar", ".tar", ".tgz", ".zip", ".dmg", ".exe")

	not_parseable_resources = (".epub", ".mobi", ".docx", ".doc",
							   ".opf", ".7z", ".ibooks", ".cbr", ".avi",
							   ".mkv", ".pdf", ".iso", ".rar", ".tar", ".tgz", ".zip", ".dmg", ".exe")
	...
	def __init__(self, num_workers=1, parserobots=False, output=None,
				 ...
				 debug=False, verbose=False, images=True):
